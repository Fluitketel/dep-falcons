...
//_obj addaction ["<t color='#FFFF00'>Virtual Garage</t>", {[("garage_marker")] call opec_fnc_garageNew;}]; 
/*_obj addaction ["<t color='#FFFF00'>Virtual Garage</t>", {[("garage_marker")] call opec_fnc_garageNew;},
nil, 6, true, true, "", "vehicle _this == _this && (rank _this == ""COLONEL"" || rank _this == ""MAJOR"") "];*/ 
_obj addAction ["Open Garage",{
	BIS_fnc_garage_center = createVehicle [ "Land_HelipadEmpty_F", (getPos garage_location), [], 0, "CAN_COLLIDE" ];  
